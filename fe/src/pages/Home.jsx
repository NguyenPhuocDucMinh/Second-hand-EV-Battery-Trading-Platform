        ...
        <Container>
          <Row className="align-items-center">
            <Col md={6} className="text-start">
              <h6 className="display-4 fw-bold mb-4" style={{ color: '#416adcff', fontSize: '2.0 rem' }}>
                FPT Car hãy sủa theo cách của bạn
              </h6>

              <p className="lead mb-4 fs-5 fw-bold" style={{ color: '#000000ff' }}>
              ...
              <div className="d-flex gap-3 flex-wrap">
                ...
                <Button
                  ...
                  size="lg"
                  className="px-4 py-2 fw-semibold"
                  style={{ color: '#416adcff', borderColor: '#416adcff', borderWidth: '1.5px' }}
                >
                  Tìm xe
                </Button>
              </div>
